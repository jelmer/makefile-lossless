use crate::lossless::{
    build_prerequisites_node, build_targets_node,
    remove_with_preceding_comments, trim_trailing_newlines, Error, ErrorInfo,
    Makefile, MakefileItem, ParseError, Rule, RuleItem, SyntaxElement, SyntaxNode,
};
